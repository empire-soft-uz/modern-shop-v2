              ...
              <div className={styles.characterisInfo}>
                <div className={styles.leftSide}>
                  <button className={styles.selectedImage}>
                    <Image
                      src={`${process.env.NEXT_PUBLIC_IMAGE_API}/${selectedProduct.media[2].name}`}
                      alt="iphone 14"
                      width={353}
                      height={460}
                    />
                  ...
                  <div className={styles.character}>
                    ...
                    <div className={styles.imagesToSelect}>
                      <div className={styles.imageToSelect}>
                        <Image
                          src={`${process.env.NEXT_PUBLIC_IMAGE_API}/${selectedProduct.media[0].name}`}
                      ...
                      >
                        <Image
                          src={`${process.env.NEXT_PUBLIC_IMAGE_API}/${selectedProduct.media[1].name}`}
                          alt="another phone image"
                          width={71}
                          height={84.5}
                        />
              ...
              {controllerC === 0 ? (
                <>
                  ...
                  <div className={styles.info}>
                    ...
                    >
                      {selectedProduct.description.substring(0, textLength)} {selectedProduct.description.length > 1000 ? <button onClick={() => {
